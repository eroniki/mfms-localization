...
\begin{abstract}
    ...
    By incorporating different \gls{rf} signal wave within a \gls{gru} framework, \gls{rss} measurements are used for indoor localization purposes.
    ...
    In offline stage, the signal maps for various AP's are constructed via \gls{rss} information and learned by a network consisted of \gls{gru}, whereas the online stage contains the proposed localization method.
